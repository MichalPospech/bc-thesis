...
\def\ThesisTitle{\xxx{Modern evolutionary strategies for reinforcement learning problems}}
\def\ThesisAuthor{\xxx{Michal Pospěch}}
\def\YearSubmitted{\xxx{2021}}

% department assigned to the thesis
\def\Department{\xxx{Department of Theoretical Computer Science and Mathematical Logic}}
% Is it a department (katedra), or an institute (ústav)?
\def\DeptType{\xxx{Department}}

\def\Supervisor{\xxx{Mgr. Roman Neruda, CSc.}}
\def\SupervisorsDepartment{\xxx{Department of Theoretical Computer Science and Mathematical Logic}}

% Study programme and specialization
\def\StudyProgramme{\xxx{Computer science}}
\def\StudyBranch{\xxx{General computer science}}
...
\def\Keywords{%
\xxx{{evolutionary strategies} {reinforcement learning} {novelty search} {neuroevolution}}
}
