...
A big part of designing efficient evolutionary strategy algorithms is adapting to covariance matrix of the used multivariate normal distribution that is commonly used as variation operator The .
\cite{Schwefel1995}
\cite{Rudolph2012}
